...
public partial class GameManager : Node3D
{
	...
	public override void _Ready()
	{
		...
		iep = new IPEndPoint(IPAddress.Parse("10.3.139.178"), 9191);						//adresse + port du serveur principal
	...
	public override void _Process(double delta)
	{
		try		//voir si le serveur est en ligne
		{
			...
			else if (state == 3)
			{
				...
				iep2 = new IPEndPoint(IPAddress.Parse("10.3.139.178"), port_serv_jeu);				//nouvelle ip
